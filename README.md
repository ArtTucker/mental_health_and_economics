...
- Preeti Suryakumar : [branch](https://github.com/ArtTucker/mental_health_and_economics/tree/preeti-02)
...
\
"mh_dx_pro","company_size","mh_hurt_on_career","country_live", "mh_discussion_negative_impact","mh_discussion_coworkers", "mh_discussion_supervisors", "mh_equal_ph", "mh_observed_consequences_coworkers","mh_coverage","mh_coverage_awareness","mh_employer_discussion","mh_resources_provided","mh_anonimity","mh_dx_current"
\
**Target and Features Engineering**
\
...
**Random Forest Classifier: Pros and Limitations**
\
This analysis employed a Logistic Regression along with Random Forest Classfier.  The pros and cons of this model are represented below.
\
\
*Benefits:*
